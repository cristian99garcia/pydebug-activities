...
class Tracer(object):
    ...
    def __call__(self):
        ...
        #first switch to the terminal window
        window = self.util.activate_bundle_id('org.laptop.PyDebug')        

        self.debugger.set_trace(sys._getframe(2))
        
        #then go back to the gui we came from
        self.util.activate_xid(self.xid)
